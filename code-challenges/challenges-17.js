...
const recursionPattern = (int1, int2) => {
    ...
    if (int1 < int2) {
      baseArr.push(-4);
      baseArr.push(int1);
      baseArr.unshift(int1);
      return baseArr;
    } 
    else {
      let callingArr = recursionPattern(int1 - int2, int2);
      let resultArr = callingArr.flat(Infinity);

      resultArr.push(int1);
      resultArr.unshift(int1);
      return resultArr;
    }
  };
