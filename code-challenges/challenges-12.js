...
const cvsFiltration = (arr) => {
    let newArr = arr.filter(cv => ((cv.yearsOfExperience > 4)&&(cv.firstName != null)&&(cv.LastName != null)) );
...
const vowelsFiltration = (arr) => {
    return arr.filter(word => (word.indexOf("a")==-1)&&(word.indexOf("e")==-1)&&(word.indexOf("i")==-1)&&(word.indexOf("o")==-1)&&(word.indexOf("u")==-1) );
} 
